...
1. **Clone the repository**
   ```bash
   git clone https://github.com/divysaxena24/Mentorix.git
   cd mentorix
   ```
...
Mentorix is under active evolution. Contributions that enhance the neural architecture or design system are welcome!
